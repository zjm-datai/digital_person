!function (e, n) {
    ...
    var s = /uni-app/i.test(navigator.userAgent),
    ...
    for (
        var S, h = function () {
            ...
            y = [
                function (e) {
                    if (s || w)
                        return window.__uniapp_x_postMessage || window.__uniapp_x_ || window.__dcloud_weex_postMessage || window.__dcloud_weex_
